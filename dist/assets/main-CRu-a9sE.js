...
function useIsRSCRouterContext() {
	return import_react$21.useContext(RSCRouterContext);
}
...
function useHref(to, { relative } = {}) {
	...
	let { basename, navigator } = import_react$22.useContext(NavigationContext);
...
function useInRouterContext() {
	return import_react$22.useContext(LocationContext) != null;
}
function useLocation() {
	invariant(useInRouterContext(), `useLocation() may be used only in the context of a <Router> component.`);
	return import_react$22.useContext(LocationContext).location;
}
function useIsomorphicLayoutEffect(cb) {
	if (!import_react$22.useContext(NavigationContext).static) import_react$22.useLayoutEffect(cb);
}
function useNavigate() {
	let { isDataRoute } = import_react$22.useContext(RouteContext);
	return isDataRoute ? useNavigateStable() : useNavigateUnstable();
}
function useNavigateUnstable() {
	invariant(useInRouterContext(), `useNavigate() may be used only in the context of a <Router> component.`);
	let dataRouterContext = import_react$22.useContext(DataRouterContext);
	let { basename, navigator } = import_react$22.useContext(NavigationContext);
	let { matches } = import_react$22.useContext(RouteContext);
	let { pathname: locationPathname } = useLocation();
	let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
	let activeRef = import_react$22.useRef(false);
	useIsomorphicLayoutEffect(() => {
		activeRef.current = true;
	});
	return import_react$22.useCallback((to, options = {}) => {
...
function useResolvedPath(to, { relative } = {}) {
	...
	let { pathname: locationPathname } = useLocation();
	let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
	return import_react$22.useMemo(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [
		to,
		routePathnamesJson,
		locationPathname,
		relative
...
function useRoutesImpl(routes, locationArg, dataRouterOpts) {
	...
	let { navigator } = import_react$22.useContext(NavigationContext);
	let { matches: parentMatches } = import_react$22.useContext(RouteContext);
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`);
	...
	if (locationArg && renderedMatches) return /* @__PURE__ */ import_react$22.createElement(LocationContext.Provider, { value: {
		location: {
			pathname: "/",
			search: "",
			hash: "",
...
function DefaultErrorComponent() {
	...
	devInfo = /* @__PURE__ */ import_react$22.createElement(import_react$22.Fragment, null, /* @__PURE__ */ import_react$22.createElement("p", null, "💿 Hey developer 👋"), /* @__PURE__ */ import_react$22.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /* @__PURE__ */ import_react$22.createElement("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", /* @__PURE__ */ import_react$22.createElement("code", { style: codeStyles }, "errorElement"), " prop on your route."));
	return /* @__PURE__ */ import_react$22.createElement(import_react$22.Fragment, null, /* @__PURE__ */ import_react$22.createElement("h2", null, "Unexpected Application Error!"), /* @__PURE__ */ import_react$22.createElement("h3", { style: { fontStyle: "italic" } }, message), stack ? /* @__PURE__ */ import_react$22.createElement("pre", { style: preStyles }, stack) : null, devInfo);
}
function RSCErrorHandler({ children, error }) {
	...
	if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
		...
		if (redirect2) {
			...
			return /* @__PURE__ */ import_react$22.createElement("meta", {
				httpEquiv: "refresh",
...
function RenderedRoute({ routeContext, match, children }) {
	...
	return /* @__PURE__ */ import_react$22.createElement(RouteContext.Provider, { value: routeContext }, children);
}
function _renderMatches(matches, parentMatches = [], dataRouterOpts) {
	...
	return renderedMatches.reduceRight((outlet, match, index) => {
		...
		let getChildren = () => {
			...
			else if (match.route.Component) children = /* @__PURE__ */ import_react$22.createElement(match.route.Component, null);
			else if (match.route.element) children = match.route.element;
			else children = outlet;
			return /* @__PURE__ */ import_react$22.createElement(RenderedRoute, {
				match,
				routeContext: {
					outlet,
					matches: matches2,
		...
		return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? /* @__PURE__ */ import_react$22.createElement(RenderErrorBoundary, {
			location: dataRouterState.location,
...
function useDataRouterContext(hookName) {
	let ctx = import_react$22.useContext(DataRouterContext);
	invariant(ctx, getDataRouterConsoleError(hookName));
	return ctx;
}
function useDataRouterState(hookName) {
	let state = import_react$22.useContext(DataRouterStateContext);
	invariant(state, getDataRouterConsoleError(hookName));
	return state;
}
function useRouteContext(hookName) {
	let route = import_react$22.useContext(RouteContext);
...
function useNavigation() {
	...
	return import_react$22.useMemo(() => {
...
function useMatches() {
	...
	return import_react$22.useMemo(() => matches.map((m) => convertRouteMatchToUiMatch(m, loaderData)), [matches, loaderData]);
}
function useRouteError() {
	let error = import_react$22.useContext(RouteErrorContext);
...
function useNavigateStable() {
	...
	return import_react$22.useCallback(async (to, options = {}) => {
		warning(activeRef.current, navigateEffectWarning);
		if (!activeRef.current) return;
...
function Router({ basename: basenameProp = "/", children = null, location: locationProp, navigationType = "POP", navigator, static: staticProp = false, useTransitions }) {
	...
	let navigationContext = import_react$23.useMemo(() => ({
		basename,
		navigator,
		static: staticProp,
		useTransitions,
	...
	let locationContext = import_react$23.useMemo(() => {
	...
	return /* @__PURE__ */ import_react$23.createElement(NavigationContext.Provider, { value: navigationContext }, /* @__PURE__ */ import_react$23.createElement(LocationContext.Provider, {
		children,
...
function createRoutesFromChildren(children, parentPath = []) {
	let routes = [];
	import_react$23.Children.forEach(children, (element, index) => {
		if (!import_react$23.isValidElement(element)) return;
		let treePath = [...parentPath, index];
		if (element.type === import_react$23.Fragment) {
...
function useDataRouterContext2() {
	let context = import_react$26.useContext(DataRouterContext);
	invariant2(context, "You must render this element inside a <DataRouterContext.Provider> element");
	return context;
}
function useDataRouterStateContext() {
	let context = import_react$26.useContext(DataRouterStateContext);
	invariant2(context, "You must render this element inside a <DataRouterStateContext.Provider> element");
	return context;
}
function useFrameworkContext() {
	let context = import_react$26.useContext(FrameworkContext);
	invariant2(context, "You must render this element inside a <HydratedRouter> element");
	return context;
}
function usePrefetchBehavior(prefetch, theirElementProps) {
	let frameworkContext = import_react$26.useContext(FrameworkContext);
	let [maybePrefetch, setMaybePrefetch] = import_react$26.useState(false);
	let [shouldPrefetch, setShouldPrefetch] = import_react$26.useState(false);
	let { onFocus, onBlur, onMouseEnter, onMouseLeave, onTouchStart } = theirElementProps;
	let ref = import_react$26.useRef(null);
...
function PrefetchPageLinks({ page, ...linkProps }) {
	...
	let matches = import_react$26.useMemo(() => matchRoutes(router.routes, page, router.basename), [
		router.routes,
		page,
		router.basename
	]);
	...
	if (rsc) return /* @__PURE__ */ import_react$26.createElement(RSCPrefetchPageLinksImpl, {
		page,
		matches,
		...linkProps
	});
	return /* @__PURE__ */ import_react$26.createElement(PrefetchPageLinksImpl, {
		page,
		matches,
		...linkProps
	});
...
function useKeyedPrefetchLinks(matches) {
	...
	let [keyedPrefetchLinks, setKeyedPrefetchLinks] = import_react$26.useState([]);
	import_react$26.useEffect(() => {
...
function RSCPrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
	...
	let dataHrefs = import_react$26.useMemo(() => {
	...
	return /* @__PURE__ */ import_react$26.createElement(import_react$26.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ import_react$26.createElement("link", {
		key: href,
		rel: "prefetch",
		as: "fetch",
		href,
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
	...
	let newMatchesForData = import_react$26.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "data"), [
		page,
		nextMatches,
		matches,
		manifest,
	...
	let newMatchesForAssets = import_react$26.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, "assets"), [
		page,
		nextMatches,
		matches,
		manifest,
	...
	let moduleHrefs = import_react$26.useMemo(() => getModuleLinkHrefs(newMatchesForAssets, manifest), [newMatchesForAssets, manifest]);
	...
	return /* @__PURE__ */ import_react$26.createElement(import_react$26.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ import_react$26.createElement("link", {
		...
		href,
		...linkProps
	})), moduleHrefs.map((href) => /* @__PURE__ */ import_react$26.createElement("link", {
		key: href,
		rel: "modulepreload",
		href,
		...linkProps
	})), keyedPrefetchLinks.map(({ key, link }) => /* @__PURE__ */ import_react$26.createElement("link", {
		key,
...
function BrowserRouter({ basename, children, useTransitions, window: window2 }) {
	let historyRef = import_react$30.useRef();
	if (historyRef.current == null) historyRef.current = createBrowserHistory({
		window: window2,
		v5Compat: true
	});
	let history = historyRef.current;
	let [state, setStateImpl] = import_react$30.useState({
		action: history.action,
		location: history.location
	});
	let setState = import_react$30.useCallback((newState) => {
		if (useTransitions === false) setStateImpl(newState);
		else import_react$30.startTransition(() => setStateImpl(newState));
	}, [useTransitions]);
	import_react$30.useLayoutEffect(() => history.listen(setState), [history, setState]);
	return /* @__PURE__ */ import_react$30.createElement(Router, {
		basename,
		children,
...
function ScrollRestoration({ getKey, storageKey, ...props }) {
	let remixContext = import_react$30.useContext(FrameworkContext);
	let { basename } = import_react$30.useContext(NavigationContext);
	let location = useLocation();
	...
	let ssrKey = import_react$30.useMemo(() => {
	...
	return /* @__PURE__ */ import_react$30.createElement("script", {
		...props,
...
function useDataRouterContext3(hookName) {
	let ctx = import_react$30.useContext(DataRouterContext);
	invariant(ctx, getDataRouterConsoleError2(hookName));
	return ctx;
}
function useDataRouterState2(hookName) {
	let state = import_react$30.useContext(DataRouterStateContext);
...
function useLinkClickHandler(to, { target, replace: replaceProp, mask, state, preventScrollReset, relative, viewTransition, defaultShouldRevalidate, useTransitions } = {}) {
	...
	return import_react$30.useCallback((event) => {
		if (shouldProcessLinkClick(event, target)) {
			...
			if (useTransitions) import_react$30.startTransition(() => doNavigate());
			else doNavigate();
		}
	}, [
		location,
...
function useSubmit() {
	...
	return import_react$30.useCallback(async (target, options = {}) => {
...
function useFormAction(action, { relative } = {}) {
	let { basename } = import_react$30.useContext(NavigationContext);
	let routeContext = import_react$30.useContext(RouteContext);
...
function useScrollRestoration({ getKey, storageKey } = {}) {
	...
	usePageHide(import_react$30.useCallback(() => {
	...
	if (typeof document !== "undefined") {
		import_react$30.useLayoutEffect(() => {
			try {
...
function useViewTransitionState(to, { relative } = {}) {
	let vtContext = import_react$30.useContext(ViewTransitionContext);
...
var init_chunk_BV7QT456 = __esmMin((() => {
	...
	DataRouterContext = import_react$21.createContext(null);
	DataRouterContext.displayName = "DataRouter";
	DataRouterStateContext = import_react$21.createContext(null);
	DataRouterStateContext.displayName = "DataRouterState";
	RSCRouterContext = import_react$21.createContext(false);
	ViewTransitionContext = import_react$21.createContext({ isTransitioning: false });
	ViewTransitionContext.displayName = "ViewTransition";
	FetchersContext = import_react$21.createContext(/* @__PURE__ */ new Map());
	FetchersContext.displayName = "Fetchers";
	AwaitContext = import_react$21.createContext(null);
	AwaitContext.displayName = "Await";
	NavigationContext = import_react$21.createContext(null);
	NavigationContext.displayName = "Navigation";
	LocationContext = import_react$21.createContext(null);
	LocationContext.displayName = "Location";
	RouteContext = import_react$21.createContext({
		outlet: null,
		matches: [],
		isDataRoute: false
	});
	RouteContext.displayName = "Route";
	RouteErrorContext = import_react$21.createContext(null);
	...
	import_react$22.createContext(null);
	defaultErrorElement = /* @__PURE__ */ import_react$22.createElement(DefaultErrorComponent, null);
	RenderErrorBoundary = class extends import_react$22.Component {
		constructor(props) {
			super(props);
			this.state = {
		...
		render() {
			...
			let result = error !== void 0 ? /* @__PURE__ */ import_react$22.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ import_react$22.createElement(RouteErrorContext.Provider, {
				value: error,
				children: this.props.component
			})) : this.props.children;
			if (this.context) return /* @__PURE__ */ import_react$22.createElement(RSCErrorHandler, { error }, result);
			return result;
		}
	};
	...
	alreadyWarned = {};
	import_react$23.memo(DataRoutes2);
	import_react$23.Component;
	defaultMethod = "get";
	...
	ESCAPE_REGEX = /[&><\u2028\u2029]/g;
	FrameworkContext = import_react$26.createContext(void 0);
	FrameworkContext.displayName = "FrameworkContext";
	import_react$25.Component;
	...
	Link = import_react$30.forwardRef(function LinkWithRef({ onClick, discover = "render", prefetch = "none", relative, reloadDocument, replace: replace2, mask, state, target, to, preventScrollReset, viewTransition, defaultShouldRevalidate, ...rest }, forwardedRef) {
		let { basename, navigator, useTransitions } = import_react$30.useContext(NavigationContext);
		...
		let link = /* @__PURE__ */ import_react$30.createElement("a", {
			...rest,
			...prefetchHandlers,
		...
		return shouldPrefetch && !isAbsolute ? /* @__PURE__ */ import_react$30.createElement(import_react$30.Fragment, null, link, /* @__PURE__ */ import_react$30.createElement(PrefetchPageLinks, { page: href })) : link;
	});
	Link.displayName = "Link";
	NavLink = import_react$30.forwardRef(function NavLinkWithRef({ "aria-current": ariaCurrentProp = "page", caseSensitive = false, className: classNameProp = "", end = false, style: styleProp, to, viewTransition, children, ...rest }, ref) {
		let path = useResolvedPath(to, { relative: rest.relative });
		let location = useLocation();
		let routerState = import_react$30.useContext(DataRouterStateContext);
		let { navigator, basename } = import_react$30.useContext(NavigationContext);
		...
		return /* @__PURE__ */ import_react$30.createElement(Link, {
			...rest,
	...
	Form = import_react$30.forwardRef(({ discover = "render", fetcherKey, navigate, reloadDocument, replace: replace2, state, method = defaultMethod, action, onSubmit, relative, preventScrollReset, viewTransition, defaultShouldRevalidate, ...props }, forwardedRef) => {
		let { useTransitions } = import_react$30.useContext(NavigationContext);
		...
		let submitHandler = (event) => {
			...
			if (useTransitions && navigate !== false) import_react$30.startTransition(() => doSubmit());
			else doSubmit();
		};
		return /* @__PURE__ */ import_react$30.createElement("form", {
			ref: forwardedRef,
			method: formMethod,
			action: formAction,
...
function Header({ logoColor = "text-primary-700", showNav = false, activeTab = "Home", role = "client", notifCount = 2 }) {
	const [dropdownOpen, setDropdownOpen] = (0, import_react$20.useState)(false);
	const [mobileOpen, setMobileOpen] = (0, import_react$20.useState)(false);
	const [notifOpen, setNotifOpen] = (0, import_react$20.useState)(false);
	const notifRef = (0, import_react$20.useRef)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("a", {
						href: "/",
				...
				showNav && /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("nav", {
					className: "absolute left-1/2 hidden -translate-x-1/2 items-center gap-2 md:flex",
					children: navLinks.map((link) => /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("a", {
						href: link.path,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("span", { children: link.icon }), /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("span", { children: link.label })]
					}, link.label))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("div", {
					className: "flex flex-none items-center gap-6",
					children: [
						showNav && /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("svg", {
								...
								fill: "currentColor",
								className: "h-6 w-6",
								children: mobileOpen ? /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("path", {
									fillRule: "evenodd",
						...
						showNav && notifCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("div", {
							className: "relative",
							ref: notifRef,
							children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("button", {
							...
							}), notifOpen && /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("div", {
									...
									children: role === "provider" ? /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)(import_jsx_runtime$34.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("a", {
										href: "/provider-bookings",
										onClick: () => setNotifOpen(false),
										className: "block px-4 py-3 hover:bg-gray-50 border-b border-gray-50",
										children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("p", {
											className: "text-sm text-gray-700",
											children: ["New request from ", /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("span", {
									...
									})] }) : /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)(import_jsx_runtime$34.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("a", {
										href: "/bookings",
										onClick: () => setNotifOpen(false),
										className: "block px-4 py-3 hover:bg-gray-50 border-b border-gray-50",
										children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("p", {
						...
						showNav && /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("div", {
							className: "relative",
							children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("button", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										viewBox: "0 0 24 24",
										fill: "currentColor",
							...
							}), dropdownOpen && /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("div", {
								className: "absolute right-0 mt-2 w-48 rounded-xl border border-gray-100 bg-white py-1 shadow-lg",
								children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("a", {
									href: "/dashboard",
		...
		}), mobileOpen && showNav && /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("div", {
			className: "absolute inset-x-0 top-16 z-20 border-b border-gray-200 bg-white px-4 py-3 shadow-lg md:hidden",
			children: /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("nav", {
				...
				children: navLinks.map((link) => /* @__PURE__ */ (0, import_jsx_runtime$34.jsxs)("a", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("span", {
						className: "text-base",
						children: link.icon
					}), /* @__PURE__ */ (0, import_jsx_runtime$34.jsx)("span", { children: link.label })]
				}, link.label))
			})
		})]
	});
}
var import_react$20, import_jsx_runtime$34;
...
function StatusBadge$3({ status }) {
	return /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("span", {
...
function Dashboard() {
	const [bannerVisible, setBannerVisible] = (0, import_react$19.useState)(true);
	const [activeTab, setActiveTab] = (0, import_react$19.useState)("All");
	const [search, setSearch] = (0, import_react$19.useState)("");
	const scrollRef = (0, import_react$19.useRef)(null);
	const catScrollRef = (0, import_react$19.useRef)(null);
	const tabs = [
		"All",
		"Pending",
		"Confirmed"
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)(Header, {
				showNav: true,
				activeTab: "Home"
			}),
			bannerVisible && /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("svg", {
								xmlns: "http://www.w3.org/2000/svg",
								viewBox: "0 0 24 24",
								fill: "currentColor",
								className: "h-5 w-5",
			...
			/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("div", { className: "pointer-events-none absolute -right-10 -top-10 h-48 w-48 rounded-full bg-white/5" }),
								/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("div", { className: "pointer-events-none absolute bottom-0 left-1/2 h-32 w-32 rounded-full bg-white/5" }),
								/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("div", { className: "pointer-events-none absolute right-1/4 top-1/4 h-16 w-16 rounded-full bg-white/5" }),
								/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("img", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("h1", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("h2", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("svg", {
											xmlns: "http://www.w3.org/2000/svg",
											viewBox: "0 0 24 24",
											fill: "currentColor",
											className: "h-4 w-4",
											children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("path", { d: "M10 4L4 12l6 8V4z" }), /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("rect", {
												x: "10",
												y: "11",
												width: "12",
												height: "2"
									...
									/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("svg", {
											...
											fill: "currentColor",
											className: "h-4 w-4",
											children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("path", { d: "M14 4l6 8-6 8V4z" }), /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("rect", {
												x: "2",
												y: "11",
												width: "12",
												height: "2"
									...
									/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("a", {
										href: "#",
							...
							children: categories$1.map((cat) => /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
							...
							style: { scrollbarWidth: "none" },
							children: favourites.map((fav) => /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
											...
											}), /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("p", {
												className: "text-sm font-semibold text-gray-900",
												children: fav.name
											}), /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("p", {
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)(StatusBadge$3, { status: "Confirmed" })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
										className: "mt-3 flex items-center gap-1",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)(StarIcon$2, { filled: true }),
											/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("span", {
				...
				}), /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("aside", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("div", {
								...
								children: tabs.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("button", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("div", {
								...
								children: filteredBookings.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("p", {
								...
								}) : filteredBookings.map((booking) => /* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
									className: "mb-3 rounded-xl border border-gray-100 bg-gray-50 p-4",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
											className: "flex items-center justify-between",
											children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)(StatusBadge$3, { status: booking.status }), /* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("span", {
												className: "text-sm font-semibold text-gray-900",
										...
										/* @__PURE__ */ (0, import_jsx_runtime$33.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime$33.jsx)("p", {
												className: "text-sm font-medium text-gray-800",
...
var import_react$19, import_jsx_runtime$33, categories$1, favourites, bookings$1;
...
function AuthProvider({ children }) {
	const [isLoggedIn, setIsLoggedIn] = (0, import_react$18.useState)(false);
	const [role, setRole] = (0, import_react$18.useState)(null);
	const [isVerified, setIsVerified] = (0, import_react$18.useState)(false);
	const login = (0, import_react$18.useCallback)((userRole) => {
		setIsLoggedIn(true);
		setRole(userRole || "client");
	}, []);
	const logout = (0, import_react$18.useCallback)(() => {
		setIsLoggedIn(false);
		setRole(null);
	}, []);
	const verify = (0, import_react$18.useCallback)(() => {
		setIsVerified(true);
	}, []);
	return /* @__PURE__ */ (0, import_jsx_runtime$32.jsx)(AuthContext.Provider, {
		value: {
			isLoggedIn,
			role,
			isVerified,
...
function useAuth() {
	return (0, import_react$18.useContext)(AuthContext);
}
var import_react$18, import_jsx_runtime$32, AuthContext;
var init_AuthContext = __esmMin((() => {
	import_react$18 = /* @__PURE__ */ __toESM(require_react());
	import_jsx_runtime$32 = require_jsx_runtime();
	AuthContext = (0, import_react$18.createContext)(null);
}));
//#endregion
...
function LandingPage() {
	...
	const [howTab, setHowTab] = (0, import_react$17.useState)("client");
	const [showAuthModal, setShowAuthModal] = (0, import_react$17.useState)(false);
	const [showVerifyPrompt, setShowVerifyPrompt] = (0, import_react$17.useState)(false);
	return /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
		className: "min-h-screen bg-gray-50 pt-16",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)(Header, { showNav: false }),
			/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("h1", {
									className: "text-3xl font-extrabold leading-tight tracking-tight text-gray-900 sm:text-4xl lg:text-5xl",
									children: ["Find trusted local", /* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("span", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
									...
									}), /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("span", { children: [
										"Trusted by ",
										/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("strong", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
								className: "relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-700 via-slate-700 to-slate-800 px-6 py-10 sm:px-10 sm:py-12",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", { className: "pointer-events-none absolute -right-10 -top-10 h-48 w-48 rounded-full bg-white/5" }),
									/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", { className: "pointer-events-none absolute bottom-0 left-1/2 h-32 w-32 rounded-full bg-white/5" }),
									/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
										className: "relative z-10 max-w-lg",
										children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("h2", {
											...
											].map((item) => /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", {
						...
						children: stats$2.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
						...
						children: categories$1.map((cat) => /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("h2", {
						...
						children: (howTab === "client" ? howItWorksClient : howItWorksProvider).map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("h3", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
						...
						children: providers$1.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("h3", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)(StarIcon$1, { filled: true }),
												/* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("span", {
													className: "text-sm font-semibold text-gray-800",
													children: p.rating
												}),
												/* @__PURE__ */ (0, import_jsx_runtime$31.jsxs)("span", {
													className: "text-xs text-gray-400",
													children: [
														"(",
														p.reviews,
			...
			showAuthModal && /* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", {
			...
			showVerifyPrompt && /* @__PURE__ */ (0, import_jsx_runtime$31.jsx)("div", {
				className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 animate-fade-in",
...
var import_react$17, import_jsx_runtime$31, howItWorksClient, howItWorksProvider, stats$2, providers$1;
...
function Mascot() {
	return /* @__PURE__ */ (0, import_jsx_runtime$30.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime$30.jsx)("img", {
			src: "/assets/Panda Cropped.png",
			alt: "TaskPanda mascot",
...
function Layout({ theme = "primary", children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$29.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$29.jsx)(Header, { logoColor: theme === "green" ? "text-green-700" : "text-primary-700" }), /* @__PURE__ */ (0, import_jsx_runtime$29.jsxs)("main", {
			className: "grid min-h-screen grid-cols-1 gap-6 lg:h-screen lg:grid-cols-[60%_40%] lg:gap-0",
			children: [/* @__PURE__ */ (0, import_jsx_runtime$29.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$29.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$29.jsxs)("h1", {
						className: "font-extrabold leading-tight tracking-tight text-gray-900 text-3xl sm:text-4xl md:text-5xl xl:text-6xl",
						children: [
							"Connect with skilled",
							/* @__PURE__ */ (0, import_jsx_runtime$29.jsx)("br", { className: "hidden sm:block" }),
							"local tradespeople"
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime$29.jsx)("p", {
				...
				}), /* @__PURE__ */ (0, import_jsx_runtime$29.jsx)(Mascot, {})]
			}), typeof children === "function" ? children(a) : children]
		})]
	});
}
var import_jsx_runtime$29, accentClasses;
...
function SocialButton({ provider }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$28.jsxs)("button", {
		type: "button",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime$28.jsxs)("svg", {
				...
				viewBox: "0 0 24 24",
				"aria-hidden": "true",
				children: [isGoogle && /* @__PURE__ */ (0, import_jsx_runtime$28.jsxs)(import_jsx_runtime$28.Fragment, { children: [
				...
				] }), isFacebook && /* @__PURE__ */ (0, import_jsx_runtime$28.jsx)("path", {
					fill: "#fff",
...
function LoginPage() {
	...
	const [isSubmitting, setIsSubmitting] = (0, import_react$16.useState)(false);
	const [showPassword, setShowPassword] = (0, import_react$16.useState)(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$27.jsx)(Layout, {
		theme: "primary",
		children: (a) => /* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("form", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("label", {
									htmlFor: "email",
							...
							/* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("label", {
										...
										className: "block text-sm font-medium text-gray-700",
										children: "Password"
									}), /* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("a", {
										href: "#",
										className: "text-sm font-medium text-primary-600 hover:text-primary-800",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("input", {
										...
										children: showPassword ? /* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("svg", {
											xmlns: "http://www.w3.org/2000/svg",
											fill: "none",
											viewBox: "0 0 24 24",
											strokeWidth: 1.5,
										...
										}) : /* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("svg", {
											xmlns: "http://www.w3.org/2000/svg",
											fill: "none",
											viewBox: "0 0 24 24",
											strokeWidth: 1.5,
							...
							/* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("label", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("span", { children: "Or continue with" }),
							/* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("span", { className: "h-px flex-1 bg-gray-200" })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime$27.jsxs)("div", {
						...
						children: ["Don't have an account?", /* @__PURE__ */ (0, import_jsx_runtime$27.jsx)("a", {
							href: "/register",
...
var import_react$16, import_jsx_runtime$27;
...
function RoleCard({ value, selected, onChange, label, description, color = "primary" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$26.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$26.jsx)("input", {
			...
			onChange,
			className: "sr-only"
		}), /* @__PURE__ */ (0, import_jsx_runtime$26.jsxs)("span", {
			className: "block",
...
function RegisterPage() {
	const navigate = useNavigate();
	const [selectedRole, setSelectedRole] = (0, import_react$15.useState)("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$25.jsx)(Layout, {
		theme: "primary",
		children: (a) => /* @__PURE__ */ (0, import_jsx_runtime$25.jsx)("section", {
			className: "flex items-center justify-center bg-white px-6 pt-16 pb-6 lg:h-full sm:px-8 md:pt-20",
			children: /* @__PURE__ */ (0, import_jsx_runtime$25.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime$25.jsxs)("div", {
						className: "space-y-1 text-center",
						children: [/* @__PURE__ */ (0, import_jsx_runtime$25.jsx)("h2", {
							className: "font-bold text-2xl text-gray-900",
							children: "I want to"
					...
					/* @__PURE__ */ (0, import_jsx_runtime$25.jsxs)("form", {
						onSubmit: handleSubmit,
						className: "space-y-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime$25.jsxs)("fieldset", {
							className: "space-y-3",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime$25.jsx)("legend", {
									className: "sr-only",
									children: "Choose your account type"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime$25.jsx)(RoleCard, {
									value: "client",
					...
					/* @__PURE__ */ (0, import_jsx_runtime$25.jsxs)("div", {
						className: "text-center text-sm text-gray-600",
						children: ["Already registered?", /* @__PURE__ */ (0, import_jsx_runtime$25.jsx)("a", {
							href: "/login",
							className: `font-medium ${a.link}`,
...
var import_react$15, import_jsx_runtime$25;
...
function TermsModal({ open, onClose }) {
	const [tab, setTab] = (0, import_react$14.useState)("terms");
	if (!open) return null;
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime$24.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime$24.jsx)("div", {
						className: "space-y-4",
						children: (tab === "terms" ? termsSections : privacySections).map((s) => /* @__PURE__ */ (0, import_jsx_runtime$24.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$24.jsx)("h3", {
							className: "text-sm font-bold text-gray-900",
							children: s.title
...
var import_react$14, import_jsx_runtime$24, termsSections, privacySections;
...
function WorkerRegisterPage() {
	...
	const navigate = useNavigate();
	const [formData, setFormData] = (0, import_react$13.useState)({
		username: "",
		email: "",
		password: "",
		"confirm-password": ""
	});
	const [isSubmitting, setIsSubmitting] = (0, import_react$13.useState)(false);
	const [error, setError] = (0, import_react$13.useState)("");
	const [agreedToTerms, setAgreedToTerms] = (0, import_react$13.useState)(false);
	const [showTerms, setShowTerms] = (0, import_react$13.useState)(false);
	const handleChange = (e) => {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime$23.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime$23.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime$23.jsx)("a", {
							href: "/register",
					...
					/* @__PURE__ */ (0, import_jsx_runtime$23.jsxs)("div", {
						className: "text-center text-sm text-gray-600",
						children: ["Already have an account?", /* @__PURE__ */ (0, import_jsx_runtime$23.jsx)("a", {
							href: "/login",
							className: `font-medium ${a.link}`,
							children: "Log in here"
						})]
...
var import_react$13, import_jsx_runtime$23;
...
function ClientRegisterPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$22.jsx)(Layout, {
		theme: "primary",
		children: (a) => /* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)(import_jsx_runtime$22.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("section", {
			className: "flex items-center justify-center bg-white px-6 pt-16 pb-6 lg:h-full sm:px-8 md:pt-20",
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)("form", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("label", {
									htmlFor: "fullName",
									className: "block text-sm font-medium text-gray-700",
									children: "Full Name"
								}), /* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("input", {
									type: "text",
									id: "fullName",
									name: "fullName",
									autoComplete: "name",
							...
							error && /* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("p", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)("div", {
								className: "flex items-start gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("input", {
									type: "checkbox",
									id: "agreeTerms",
									checked: agreedToTerms,
									onChange: (e) => setAgreedToTerms(e.target.checked),
									className: "mt-1 h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
								}), /* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)("label", {
									htmlFor: "agreeTerms",
									className: "text-sm text-gray-600",
									children: [
										"I agree to the",
					...
					/* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)("div", {
						className: "flex items-center gap-3 text-sm text-gray-400",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("span", { className: "h-px flex-1 bg-gray-200" }),
							/* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("span", { children: "Or Sign up with" }),
							/* @__PURE__ */ (0, import_jsx_runtime$22.jsx)("span", { className: "h-px flex-1 bg-gray-200" })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)("div", {
						className: "grid grid-cols-2 gap-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime$22.jsx)(SocialButton, { provider: "google" }), /* @__PURE__ */ (0, import_jsx_runtime$22.jsx)(SocialButton, { provider: "facebook" })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$22.jsxs)("div", {
						className: "text-center text-sm text-gray-600",
						children: [
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime$22.jsx)(TermsModal, {
			open: showTerms,
			onClose: () => setShowTerms(false)
		})] })
	});
}
var import_react$12, import_jsx_runtime$22;
...
function ClientDashboardPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime$21.jsx)(Dashboard, {});
}
...
function StatusBadge$2({ status }) {
	return /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
		className: `inline-block rounded-full border px-2.5 py-0.5 text-xs font-medium ${{
			"Pending Request": "bg-amber-100 text-amber-700 border-amber-200",
			Confirmed: "bg-green-100 text-green-700 border-green-200",
			Completed: "bg-blue-100 text-blue-700 border-blue-200",
...
function ProviderDashboard() {
	const [jobs, setJobs] = (0, import_react$11.useState)(myJobs);
	const [requests, setRequests] = (0, import_react$11.useState)(incomingRequests$1);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)(Header, {
			showNav: true,
			activeTab: "Home",
			role: "provider"
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
					className: "mb-6",
					children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("h1", {
						className: "text-2xl font-bold text-gray-900",
				...
				/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
					...
					children: stats$1.map((s) => /* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("h2", {
									...
									children: ["Incoming Requests", requests.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
							...
							}), requests.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
								className: "py-12 text-center",
								children: /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("p", {
									className: "text-sm text-gray-400",
									children: "No incoming requests"
								})
							}) : /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
								className: "divide-y divide-gray-100",
								children: requests.map((req) => /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
									className: "px-5 py-4",
									children: /* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
														className: "text-sm font-semibold text-gray-900",
														children: req.client
													}), /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)(StatusBadge$2, { status: "Pending Request" })]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("p", {
												...
												/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("p", {
													className: "mt-2 flex items-center gap-3 text-xs text-gray-400",
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: req.address }),
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: req.date }),
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: req.time }),
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
							...
							}), jobs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
								className: "py-12 text-center",
								children: /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("p", {
									className: "text-sm text-gray-400",
								...
								className: "divide-y divide-gray-100",
								children: jobs.map((job) => /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
									className: "px-5 py-4",
									children: /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("div", {
										className: "flex items-start justify-between gap-3",
										children: /* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
														className: "text-sm font-semibold text-gray-900",
														children: job.client
													}), /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)(StatusBadge$2, { status: job.status })]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("p", {
													className: "mt-1 text-sm font-medium text-gray-700",
													children: job.task
												...
												/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("p", {
													className: "mt-2 flex items-center gap-3 text-xs text-gray-400",
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: job.address }),
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: job.date }),
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: job.time }),
														/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
															className: "font-medium text-gray-600",
															children: job.price
														})
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("a", {
									href: "/messages",
									className: "flex items-center gap-3 px-5 py-3 text-sm text-gray-600 transition hover:bg-gray-50",
									children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
										className: "text-base",
										children: "💬"
									}), /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: "Messages" })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("a", {
									href: "/bookings",
									className: "flex items-center gap-3 px-5 py-3 text-sm text-gray-600 transition hover:bg-gray-50",
									children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
										className: "text-base",
										children: "📋"
									}), /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: "All Bookings" })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime$20.jsxs)("a", {
									href: "/profile",
									className: "flex items-center gap-3 px-5 py-3 text-sm text-gray-600 transition hover:bg-gray-50",
									children: [/* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", {
										className: "text-base",
										children: "👤"
									}), /* @__PURE__ */ (0, import_jsx_runtime$20.jsx)("span", { children: "My Profile" })]
								})
							]
						})]
					})]
...
var import_react$11, import_jsx_runtime$20, stats$1, incomingRequests$1, myJobs;
...
function ProviderDashboardPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime$19.jsx)(ProviderDashboard, {});
}
...
function CheckBox({ label, count, defaultChecked = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("label", {
		...
		children: [
			...
			count !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("span", {
				className: "text-xs text-gray-400",
				children: [
					"[",
					count,
...
function Explore() {
	const [searchService, setSearchService] = (0, import_react$10.useState)("");
	const [searchLocation, setSearchLocation] = (0, import_react$10.useState)("");
	const [showAllCats, setShowAllCats] = (0, import_react$10.useState)(false);
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
					className: "relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-700 via-slate-700 to-slate-800 px-6 py-10 sm:px-10 sm:py-12",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", { className: "pointer-events-none absolute -right-10 -top-10 h-48 w-48 rounded-full bg-white/5" }),
						/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", { className: "pointer-events-none absolute bottom-0 left-1/2 h-32 w-32 rounded-full bg-white/5" }),
						/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", {
							className: "pointer-events-none absolute -bottom-4 -right-2 hidden h-48 w-40 overflow-hidden sm:block md:right-8",
						...
						/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
							className: "relative z-10 max-w-lg",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("h1", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", { className: "h-8 w-px bg-gray-200" }),
										/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("input", {
											type: "text",
			...
			/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("aside", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("h2", {
									className: "text-base font-bold text-gray-900",
							...
							/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("h3", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "TESDA CERTIFIED ONLY" }), /* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "ID VERIFIED PROFESSIONALS" })]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
								className: "mb-5",
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", {
										className: "space-y-2.5",
										children: visibleCats.map((cat) => /* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, {
											label: cat.name,
											count: cat.count
										}, cat.name))
									}),
									filterCategories.length >= 4 && /* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("button", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("h3", {
									...
									className: "space-y-2.5",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "Available Today" }),
										/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "Available Tomorrow" }),
										/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "This week" }),
										/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "Weekends only" })
									]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("h3", {
								...
								className: "space-y-2.5",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, {
										label: "5 stars & up",
										count: 42
									}),
									/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, {
									...
									/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "3 stars & up" }),
									/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(CheckBox, { label: "2 stars & up" })
								]
							})] })
						]
					})
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
						...
						children: providers.map((provider) => /* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("div", {
										className: "flex items-start justify-between",
										children: /* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("h3", {
											className: "text-sm font-bold text-gray-900",
									...
									/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime$18.jsxs)("div", {
											className: "flex items-center gap-1",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)(StarIcon, { filled: true }),
												/* @__PURE__ */ (0, import_jsx_runtime$18.jsx)("span", {
													className: "text-sm font-semibold text-gray-800",
...
var import_react$10, import_jsx_runtime$18, filterCategories, providers;
...
function ExplorePage() {
	return /* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(Explore, {});
}
...
function BookingsPage() {
	const [activeTab, setActiveTab] = (0, import_react$9.useState)("All");
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$16.jsx)(Header, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime$16.jsx)("div", {
					...
					children: tabs$1.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime$16.jsx)("button", {
						onClick: () => setActiveTab(tab),
				...
				/* @__PURE__ */ (0, import_jsx_runtime$16.jsx)("div", {
					className: "space-y-4",
					children: filteredBookings.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime$16.jsx)("div", {
					...
					}) : filteredBookings.map((booking) => /* @__PURE__ */ (0, import_jsx_runtime$16.jsx)("div", {
						className: "overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm transition hover:shadow-md",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime$16.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime$16.jsxs)("div", {
										...
										className: "flex items-center gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime$16.jsx)(StatusDot$1, { status: booking.status }), /* @__PURE__ */ (0, import_jsx_runtime$16.jsx)(StatusBadge$1, { status: booking.status })]
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime$16.jsxs)("div", {
...
var import_react$9, import_jsx_runtime$16, bookings, tabs$1;
...
function StatusDot({ status }) {
	return /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", { className: `inline-block h-2 w-2 rounded-full ${{
		"Pending Request": "bg-amber-500",
		Confirmed: "bg-green-500",
		Completed: "bg-blue-500",
...
function ProviderBookingsPage() {
	...
	const [requests, setRequests] = (0, import_react$8.useState)(incomingRequests);
	const [bookings, setBookings] = (0, import_react$8.useState)(myBookings);
	function acceptRequest(id) {
		const req = requests.find((r) => r.id === id);
		if (!req) return;
		setRequests((prev) => prev.filter((r) => r.id !== id));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)(Header, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
					className: "mb-6",
					children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("h1", {
						className: "text-2xl font-bold text-gray-900",
						children: "My Bookings"
				...
				/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("div", {
					className: "mb-6 flex gap-1",
					children: tabs.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("button", {
						onClick: () => setActiveTab(tab),
						className: `rounded-lg px-4 py-2 text-sm font-medium transition ${activeTab === tab ? "bg-gray-900 text-white" : "bg-white text-gray-600 ring-1 ring-gray-200 hover:bg-gray-50"}`,
						children: tab
					}, tab))
				}),
				showIncoming && requests.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
					className: "mb-8",
					children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("h2", {
						className: "mb-4 text-lg font-semibold text-gray-900",
						children: ["Incoming Requests", requests.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", {
						...
						className: "space-y-4",
						children: filteredIncoming.map((req) => /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("div", {
							className: "overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm transition hover:shadow-md",
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
											...
											}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("h3", {
												className: "text-base font-semibold text-gray-900",
												children: req.client
											}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("p", {
												className: "text-sm text-gray-500",
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)(StatusBadge, { status: "Pending Request" })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
										className: "mt-4 border-t border-gray-100 pt-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("h4", {
											className: "text-sm font-semibold text-gray-800",
											children: req.task
										}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("p", {
											className: "mt-1 text-sm leading-relaxed text-gray-500",
									...
									/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
											...
											}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", { children: req.address })]
										}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
											className: "flex items-center gap-1.5",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("svg", {
													xmlns: "http://www.w3.org/2000/svg",
													viewBox: "0 0 24 24",
													fill: "currentColor",
													className: "h-4 w-4 text-gray-400",
												...
												/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", { children: req.date }),
												/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", {
													className: "text-gray-300",
													children: "|"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", { children: req.time })
											]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
				...
				showBookings && bookings.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("h2", {
					className: "mb-4 text-lg font-semibold text-gray-900",
					children: "My Bookings"
				}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("div", {
					className: "space-y-4",
					children: filteredBookings.map((booking) => /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("div", {
						className: "overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm transition hover:shadow-md",
						children: /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
							className: "p-5 sm:p-6",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
										...
										className: "flex items-center gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)(StatusDot, { status: booking.status }), /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)(StatusBadge, { status: booking.status })]
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
									className: "mt-4 border-t border-gray-100 pt-4",
								...
								/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", { children: booking.address })]
									}), /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
										className: "flex items-center gap-1.5",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("svg", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", { children: booking.date }),
											/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", {
												className: "text-gray-300",
												children: "|"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("span", { children: booking.time })
										]
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)("div", {
				...
				showIncoming && requests.length === 0 && showBookings && bookings.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("div", {
					className: "rounded-xl border border-gray-200 bg-white py-16 text-center",
				...
				showIncoming && requests.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)("div", {
...
var import_react$8, import_jsx_runtime$15, incomingRequests, myBookings, tabs;
...
function MessagesPage() {
	const [selectedId, setSelectedId] = (0, import_react$7.useState)(null);
	const [input, setInput] = (0, import_react$7.useState)("");
	const selectedConv = conversations$1.find((c) => c.id === selectedId);
	const chatMessages = selectedConv ? messagesData$1[selectedId] || [] : [];
	return /* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
		className: "min-h-screen bg-gray-50 pt-16",
		children: [/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)(Header, {
			showNav: true,
			activeTab: "Messages"
		}), /* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
			className: "mx-auto flex min-h-[calc(100vh-4rem)] max-w-5xl px-4 sm:px-6 lg:px-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
				className: `flex-1 h-full w-full shrink-0 border-r border-gray-200 bg-white ${selectedId ? "hidden md:block md:w-80 lg:w-96" : ""}`,
				children: [/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("div", {
					className: "px-5 py-5",
					children: /* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("h1", {
						className: "text-lg font-bold text-gray-900",
						children: [
							"Messages",
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("span", {
								className: "ml-1 rounded-full bg-primary-100 px-2.5 py-1 text-xs font-medium text-primary-700",
								children: conversations$1.filter((c) => c.unread).length
							})
						]
					})
				}), /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("div", {
					className: "flex flex-col",
					children: conversations$1.map((conv) => /* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("button", {
						onClick: () => setSelectedId(conv.id),
						className: `flex items-center gap-3.5 border-b border-gray-100 px-5 py-4 text-left transition hover:bg-gray-50 ${selectedId === conv.id ? "bg-gray-50" : ""}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("p", {
							...
							conv.unread && /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("span", { className: "mt-1 block h-2.5 w-2.5 shrink-0 rounded-full bg-primary-600" })
						]
					}, conv.id))
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("div", {
				className: `flex h-full flex-1 flex-col bg-white ${selectedId ? "" : "hidden md:flex"}`,
				children: selectedConv ? /* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)(import_jsx_runtime$14.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
						className: "flex items-center gap-3 border-b border-gray-200 px-5 py-5",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("button", {
								...
								"aria-label": "Back",
								children: /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("svg", {
									xmlns: "http://www.w3.org/2000/svg",
									viewBox: "0 0 24 24",
									fill: "currentColor",
									className: "h-5 w-5",
							...
							/* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("p", {
								className: "text-sm font-semibold text-gray-900",
								children: selectedConv.name
							}), /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("p", {
								className: "text-xs text-gray-500",
								children: selectedConv.cred
							})] })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("div", {
						className: "flex-1 overflow-y-auto px-5 py-5 space-y-4",
						children: chatMessages.map((msg) => /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("div", {
							className: `flex ${msg.sender === "me" ? "justify-end" : "justify-start"}`,
							children: /* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
								className: `max-w-[80%] rounded-2xl px-5 py-3 text-sm leading-relaxed ${msg.sender === "me" ? "rounded-br-sm bg-primary-600 text-white" : "rounded-bl-sm bg-gray-100 text-gray-800"}`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("p", { children: msg.text }), /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("p", {
									className: `mt-1.5 text-right text-[11px] ${msg.sender === "me" ? "text-teal-200" : "text-gray-400"}`,
									children: msg.time
								})]
							})
						}, msg.id))
					...
					/* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
						className: "flex items-center gap-3 border-t border-gray-200 px-5 py-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("input", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("svg", {
								...
								fill: "currentColor",
								className: "h-4 w-4",
								children: /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("path", { d: "M3.478 2.405a.75.75 0 00-.926.94l2.432 7.905H13.5a.75.75 0 010 1.5H4.984l-2.432 7.905a.75.75 0 00.926.94 60.519 60.519 0 0018.445-8.986.75.75 0 000-1.218A60.517 60.517 0 003.478 2.405z" })
							})
						})]
					})
				] }) : /* @__PURE__ */ (0, import_jsx_runtime$14.jsxs)("div", {
					className: "flex h-full flex-1 flex-col items-center justify-center text-center px-5",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime$14.jsx)("svg", {
							xmlns: "http://www.w3.org/2000/svg",
							viewBox: "0 0 24 24",
							fill: "currentColor",
...
var import_react$7, import_jsx_runtime$14, conversations$1, messagesData$1;
...
function ProviderMessagesPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", {
		className: "min-h-screen bg-gray-50 pt-16",
		children: [/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)(Header, {
			showNav: true,
			activeTab: "Messages",
			role: "provider"
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("div", {
					className: "px-5 py-5",
					children: /* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("h1", {
						className: "text-lg font-bold text-gray-900",
						children: [
							"Messages",
							" ",
					...
					className: "flex flex-col",
					children: conversations.map((conv) => /* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("button", {
						onClick: () => setSelectedId(conv.id),
						className: `flex items-center gap-3.5 border-b border-gray-100 px-5 py-4 text-left transition hover:bg-gray-50 ${selectedId === conv.id ? "bg-gray-50" : ""}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("div", {
								className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-accent-100 text-sm font-bold text-accent-700",
								children: conv.name.charAt(0)
							}),
							/* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", {
								className: "min-w-0 flex-1",
							...
							conv.unread && /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("span", { className: "mt-1 block h-2.5 w-2.5 shrink-0 rounded-full bg-primary-600" })
						]
					}, conv.id))
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("div", {
				className: `flex h-full flex-1 flex-col bg-white ${selectedId ? "" : "hidden md:flex"}`,
				children: selectedConv ? /* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)(import_jsx_runtime$13.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", {
						className: "flex items-center gap-3 border-b border-gray-200 px-5 py-5",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("div", {
								className: "flex h-10 w-10 items-center justify-center rounded-full bg-accent-100 text-sm font-bold text-accent-700",
								children: selectedConv.name.charAt(0)
							}),
							/* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("p", {
								className: "text-sm font-semibold text-gray-900",
								children: selectedConv.name
							}), /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("p", {
								className: "text-xs text-gray-500",
					...
					/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("div", {
						className: "flex-1 overflow-y-auto px-5 py-5 space-y-4",
						children: chatMessages.map((msg) => /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("div", {
							className: `flex ${msg.sender === "me" ? "justify-end" : "justify-start"}`,
							children: /* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", {
								className: `max-w-[80%] rounded-2xl px-5 py-3 text-sm leading-relaxed ${msg.sender === "me" ? "rounded-br-sm bg-primary-600 text-white" : "rounded-bl-sm bg-gray-100 text-gray-800"}`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("p", { children: msg.text }), /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("p", {
									className: `mt-1.5 text-right text-[11px] ${msg.sender === "me" ? "text-teal-200" : "text-gray-400"}`,
									children: msg.time
								})]
							})
					...
					/* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("input", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("svg", {
								...
								fill: "currentColor",
								className: "h-4 w-4",
								children: /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)("path", { d: "M3.478 2.405a.75.75 0 00-.926.94l2.432 7.905H13.5a.75.75 0 010 1.5H4.984l-2.432 7.905a.75.75 0 00.926.94 60.519 60.519 0 0018.445-8.986.75.75 0 000-1.218A60.517 60.517 0 003.478 2.405z" })
							})
						})]
					})
				] }) : /* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)("div", {
...
var import_react$6, import_jsx_runtime$13, conversations, messagesData;
...
function VerificationPage() {
	...
	const [formData, setFormData] = (0, import_react$2.useState)({
		validId: "",
		certificate: ""
	});
				...
				/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("p", {
							...
							children: "Submit a valid ID to unlock all features on TaskPanda"
						})
					]
				}),
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("label", {
								className: "block text-sm font-medium text-gray-700",
								children: ["Valid ID ", /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("p", {
								className: "mt-1 text-xs text-gray-400",
								children: "A valid government-issued ID is required"
							})
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("label", {
...
//# sourceMappingURL=main-CRu-a9sE.js.map