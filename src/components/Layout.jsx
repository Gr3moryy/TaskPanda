  ...
  return (
    <>
      ...
      <main className="grid min-h-screen grid-cols-1 gap-6 lg:h-screen lg:grid-cols-[60%_40%] lg:gap-0">
        <section className="flex flex-col items-center justify-center gap-6 px-6 pt-16 pb-6 text-center md:pt-20 lg:h-full lg:items-start lg:text-left lg:px-8 lg:pt-12 xl:gap-8 xl:pt-20">
          <div>
            <h1
